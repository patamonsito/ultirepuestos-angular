...
router.post('/tack-id', API.POST_TRACK_CODE)*/
    ...
    retryPayment(Seguimiento: any, MetodoPago: any, Token: any){
        return this.http.post('http://localhost:3000/api/retry-payment', { Seguimiento, MetodoPago, Token });
    }
    ...
    getFacturacion(id: any){
        return this.http.post('http://localhost:3000/api/get-orden', { id: id });
    }
    searchProductFast(id: any){
        return this.http.post('http://localhost:3000/api/get-products-fast', { Buscar: id });
    }

    getAplications(id: any){
        return this.http.post('http://localhost:3000/api/get-aplications', { id }); 
    }


    searchProductsByCodeModel(Page: any, CodigoModelo: any, Key: any = ''){

        return this.http.post('http://localhost:3000/api/products/model', { Page, CodigoModelo, Key });
    }

    searchProducts(key: any, options: any){
        return this.http.post('http://localhost:3000/api/get-products', { ...key, ...options});
    }

    getMarcas(){
        return this.http.get('http://localhost:3000/api/marcas-vehiculos');
    }

    buscarModelos(nombre: any){
        return this.http.post('http://localhost:3000/api/models', {nombre: nombre});
    }
    ...
    getProduct(id: string): any {
        ...
        return this.http.post('http://localhost:3000/api/product', {id: id});
    }
    ...
    getFeaturedProducts(categorySlug: string|null = null, limit: number|null = null): Observable<Product[]> {
        ...
        return this.http.post<Product[]>('http://localhost:3000/api/ofertas', { Repuesto: categorySlug, limit: limit, Public: true });
