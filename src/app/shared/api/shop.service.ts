...
export class ShopService {
    ...
    getFacturacion(id: any){
        return this.http.post('http://www.service.ulti.cl/api/get-orden', { id: id });
    }
    searchProductFast(id: any){
        return this.http.post('http://www.service.ulti.cl/api/get-products-fast', { Buscar: id });
    }

    getAplications(id: any){
        return this.http.post('http://www.service.ulti.cl/api/get-aplications', { id }); 
    }


    searchProductsByCodeModel(Page: any, CodigoModelo: any, Key: any = ''){

        return this.http.post('http://www.service.ulti.cl/api/products/model', { Page, CodigoModelo, Key });
    }

    searchProducts(key: any, options: any){
        return this.http.post('http://www.service.ulti.cl/api/get-products', { ...key, ...options});
    }

    getMarcas(){
        return this.http.get('http://www.service.ulti.cl/api/marcas-vehiculos');
    }

    buscarModelos(nombre: any){
        return this.http.post('http://www.service.ulti.cl/api/models', {nombre: nombre});
    }

    generarOrdenCompra(body: any){
        return this.http.post('http://www.service.ulti.cl/api/generar-orden', body);
    }

    actualizarUsuario(body: any, id: string){
        return this.http.patch('http://www.service.ulti.cl/api/user/'+id, body);
    }

    registrarUsuario(body: Usuario){
        return this.http.post('http://www.service.ulti.cl/api/crear-usuario', body);
    }

    changePassword(body: any){
        return this.http.post('http://www.service.ulti.cl/api/change-password', body);
    }

    getRegiones(){
        return this.http.get<Regiones[]>('http://www.service.ulti.cl/api/get-regiones');
    }


    añadirDireccion(body: Direcciones){
        return this.http.post('http://www.service.ulti.cl/api/add-direccion', body);
    }

    actualizarDireccion(body: Direcciones){
        return this.http.post('http://www.service.ulti.cl/api/update-direccion', body);
    }

    eliminarDireccion(id: string){
        return this.http.delete('http://www.service.ulti.cl/api/eliminar-direccion/'+id);
    }
    ...
    suscribirCorreo(correo: string){
        return this.http.post('http://www.service.ulti.cl/api/suscribir', {Correo: correo});
    }
    ...
    getCategories(parent: Partial<Category>|null = null, depth: number = 0): Observable<Category[]> {
        ...
        // };
        //
        return this.http.post<Category[]>('http://www.service.ulti.cl/api/categorias', {});
    ...
    getProduct(id: string): any {
        ...
        return this.http.post('http://www.service.ulti.cl/api/product', {id: id});
    }
    ...
    getBestsellers(limit: number|null = null): Observable<Product[]> {
        ...
        return this.http.post<Product[]>('http://www.service.ulti.cl/api/productos-populares', {});
        // This is for demonstration purposes only. Remove it and use the code above.
    ...
    getPopulateCustom(repuesto: string): Observable<Product[]> {
        ...
        return this.http.post<Product[]>('http://www.service.ulti.cl/api/productos-populares', { Repuesto: repuesto});
        // This is for demonstration purposes only. Remove it and use the code above.
        // return getBestsellers(limit);
    }
    ...
    getFeaturedProducts(categorySlug: string|null = null, limit: number|null = null): Observable<Product[]> {
        ...
        return this.http.post<Product[]>('http://www.service.ulti.cl/api/ofertas', { Repuesto: categorySlug, limit: limit, Public: true });
    ...
    getLatestProducts(categorySlug: string|null = null, limit: number|null = null): Observable<Product[]> {
        ...
        return this.http.post<Product[]>('http://www.service.ulti.cl/api/productos-relacionados', { Repuesto: categorySlug });
        // This is for demonstration purposes only. Remove it and use the code above.
